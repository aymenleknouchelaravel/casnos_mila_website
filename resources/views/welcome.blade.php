...
<body>
        ...
        <header class="header-one">
            <div class="top-header">
                <div class="container clearfix">
                    <div class="logo float-left"><a href="index.html"><img height="80px"
                                src="/landing/images/logo/logo.png" alt=""></a>
                    </div>
                    <div class="address-wrapper float-right">
                        <ul>
                            <li class="address">
                                ...
                                <h6>Address:</h6>
                                <p>02 Rue zeghdoud Ali, Mila 43000 </p>
                            </li>
                            <li class="address">
                            ...
                            <li class="quotes"><a href="/login">Login</a></li>
                        </ul>
                    </div> <!-- /.address-wrapper -->
                </div> <!-- /.container -->
            </div> <!-- /.top-header -->
   ...
   -->
        <div id="theme-main-banner" class="banner-one">
            <div data-src="/landing/images/home/slide-1.jpg">
                <div class="camera_caption">

                </div> <!-- /.camera_caption -->
            </div>
            <div data-src="/landing/images/home/slide-2.jpg">
                <div class="camera_caption">
            ...
            <div class="top-features-slide">
                <div class="item">
                    <div class="main-content" style="background:#f6f6f6;">
                        <img src="/landing/images/icon/2.png" alt="">
                        <h6><a href="#">Request to join remotely</a></h6>
                    </div> <!-- /.main-content -->
                </div> <!-- /.item -->
                <div class="item">
                    <div class="main-content" style="background:#efefef;">
                        <img src="/landing/images/icon/3.png" alt="">
                        <h6><a href="#">Declaration of activity</a></h6>
                    </div> <!-- /.main-content -->
                </div> <!-- /.item -->
                <div class="item">
                    <div class="main-content" style="background:#e9e9e9;">
                        <img src="/landing/images/icon/4.png" alt="">
                        <h6><a href="#">Remote retirement request</a></h6>
                    </div> <!-- /.main-content -->
                </div> <!-- /.item -->
        ...
        <div class="about-compnay section-spacing">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-12"><img src="/landing/images/home/1.jpg" alt=""></div>
   ...
   -->
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="single-service">
                                <div class="img-box"><img src="/landing/images/home/3.jpg" alt=""></div>
                                <div class="text">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="single-service">
                                <div class="img-box"><img src="/landing/images/home/4.jpg" alt=""></div>
                                <div class="text">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="single-service">
                                <div class="img-box"><img src="/landing/images/home/5.jpg" alt=""></div>
                                <div class="text">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="single-service">
                                <div class="img-box"><img src="/landing/images/home/6.jpg" alt=""></div>
                                <div class="text">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="single-service">
                                <div class="img-box"><img src="/landing/images/home/7.jpg" alt=""></div>
                                <div class="text">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="single-service">
                                <div class="img-box"><img src="/landing/images/home/8.jpg" alt=""></div>
                                <div class="text">
        ...
        <!-- Camera Slider -->
        <script src='/landing/vendor/Camera-master/scripts/jquery.mobile.customized.min.js'></script>
        <script src='/landing/vendor/Camera-master/scripts/jquery.easing.1.3.js'></script>
        <script src='/landing/vendor/Camera-master/scripts/camera.min.js'></script>
        <!-- menu  -->
        <script src="/landing/vendor/menu/src/js/jquery.slimmenu.js"></script>
        <!-- WOW js -->
        <script src="/landing/vendor/WOW-master/dist/wow.min.js"></script>
        <!-- owl.carousel -->
